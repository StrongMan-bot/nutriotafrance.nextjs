...
const InsiderClubModal: React.FC<InsiderClubModalProps> = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.name.trim() || !formData.email.trim() || !formData.email.includes('@')) {
      setError('Veuillez entrer votre nom et une adresse email valide.');
      return;
    }
    ...
    try {
      ...
      setError("Quelque chose s'est mal passé. Veuillez réessayer plus tard.");
    } finally {
          ...
          {!isSuccess ? (
            <>
              ...
              <p className="text-gray-600 text-center mb-8 leading-relaxed">
                Entrez simplement votre nom et votre email et nous vous enverrons immédiatement le code de réduction.
              </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                >
                  {isSubmitting ? 'Envoi en cours...' : 'Rejoindre Maintenant'}
                </button>
              </form>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                Merci d&apos;avoir rejoint le Nutriota Insider Club !
              </p>
