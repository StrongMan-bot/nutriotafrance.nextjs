...
const Header = () => {
  ...
  const [selectedLanguage, setSelectedLanguage] = useState(() => {
    // Always initialize with French as default to prevent hydration mismatch
  ...
  const handleLanguageChange = async (langCode: string) => {
    ...
    try {
      ...
      if (langCode === 'en') {
        ...
        setSelectedLanguage({ code: 'fr', name: 'Français', flag: '🇫🇷' });
      }
  ...
  useEffect(() => {
    ...
    if (currentLang === 'en') {
      ...
      // Default to French for any other language or if not set
      setSelectedLanguage({ code: 'fr', name: 'Français', flag: '🇫🇷' });
    }
  }, [i18n.language]);
  ...
  const products = [
    {
      ...
      "name": "Nutriota Propolis | 1000 mg (120 Tablets)",
      "price": "€17.90",
      "image": "https://m.media-amazon.com/images/I/61A6d2CFcWL._AC_SX522_.jpg",
      "link": "https://www.amazon.fr/dp/B08911KNXN"
    },
    {
      "id": 2,
      ...
      "price": "€10.90",
      "image": "https://m.media-amazon.com/images/I/61shw96Kl9L.__AC_SX300_SY300_QL70_ML2_.jpg",
      "link": "https://www.amazon.fr/dp/B0DDLCNKVX"
    },
    {
      "id": 3,
      "category": t('products.supplements'),
      ...
      "price": "€24.99",
      "image": "https://m.media-amazon.com/images/I/61dx-e6SnyL.__AC_SX300_SY300_QL70_ML2_.jpg",
      "link": "https://www.amazon.fr/dp/B08XQLJ78K"
    }
  ];

  const carouselItems = [
    { id: 1, titleKey: "carousel.supplements.title", descriptionKey: "carousel.supplements.description", image: "/images/FranceHeaderSupplement.jpg", productId: 1 },
    { id: 2, titleKey: "carousel.minerals.title", descriptionKey: "carousel.minerals.description", image: "/images/FranceHeaderMineral.jpg", productId: 2 },
  ];
  ...
  const handleMobileLanguageToggle = () => {
    ...
    const targetLanguage = selectedLanguage.code === 'fr' ? 'en' : 'fr';
            ...
            <div className="hidden lg:flex relative" ref={languageRef}>
              ...
              {isLanguageOpen && (
                <div className="absolute top-full right-0 mt-2 w-full bg-white rounded-xl shadow-lg border border-gray-100 py-2 z-50">
                  {/* Changed order: Français first, then English */}
                  <button 
                    onClick={() => {
                      if (!isLanguageLoading) {
                  ...
                  >
                    ...
                    <span className="font-medium text-sm truncate">Français</span>
                    {isLanguageLoading && selectedLanguage.code !== 'fr' && (
